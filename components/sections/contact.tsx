      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-10">
            ...
            challenges, and remote opportunities. Whether you have a question or
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {links.map((link, i) => (
              <motion.a
                ...
                className="inline-flex items-center gap-3 px-7 py-3.5 rounded-full font-semibold text-sm text-foreground bg-[var(--btn-bg)] border border-[var(--btn-border)] hover:bg-[var(--btn-bg-hover)] hover:border-accent-blue/[0.3] hover:-translate-y-0.5 hover:shadow-[0_0_24px_rgba(79,140,255,0.08)] transition-all duration-300 backdrop-blur-sm"
              >
                {link.icon}
                {link.label}
              </motion.a>
